...
data={'101': [1451,63,1548,170], // 左から順に 左上のx座標、y座標。右下のx座標、y座標、説明
  ...
  '114': [351,87,403,171],
  '115': [257,108,306,171],
  '116': [112,87,259,171, "▶企画名◀\n真鍮に集中\n▶団体名◀\nおそらく工学部\n▶企画説明◀\n"],
  '117': [256,252,354,443],
  '118': [378,341,477,452],
  '119': [449,191,546,276],
  '120': [544,191,594,254],
  '121': [591,191,690,277],
  '122':[733,191,930,277, "お休み処です。休憩ができます。"],
  ...
  '185':[305, 672, 351, 708],
  '186':[391, 869, 418, 946],
  '201':[1141, 191, 1218, 270, "▶企画名◀\nカジノ\n▶団体名◀1年5組\n\n▶企画説明◀\n"],
  '202':[1141, 266, 1219, 347, "▶企画名◀\nホーンテッド迷宮\n▶団体名◀\n1年8組\n▶企画説明◀\n"],
  '203':[1141, 342, 1219, 421, "▶企画名◀\n喫茶さんのさん\n▶団体名◀\n3年3組\n▶企画説明◀\n"],
  '204':[1141, 418, 1218, 498, "▶企画名◀\n山岳部展示会\n▶団体名◀\n山岳部\n▶企画説明◀\n"],
  '205':[1141, 493, 1218, 572, "▶企画名◀\n私の・俺のキーホルダー\n▶団体名◀\ndesign造形部\n▶企画説明◀\n"],
  '206':[1141, 569, 1219, 649, "▶企画名◀\n脱出ホラーゲーム\n▶団体名◀\n3年6組\n▶企画説明◀\n"],
  '207':[1069, 272, 1119, 342, "▶企画名◀\nCyBARpunk2024\n▶団体名◀\n3年7組\n▶企画説明◀\n"],
  '208':[1069, 489, 1121, 565, "▶企画名◀\nラスタンプラリー\n▶団体名◀\n3年4組\n▶企画説明◀\n"],
  '209':[1449, 65, 1549, 277, "▶企画名◀\nそうだ、図書館に行こう\n▶団体名◀\n図書委員会\n▶企画説明◀\n"],
  ...
  '306':[1142, 568, 1218, 649],
  '307':[1071, 275, 1119, 344],
  '308':[1071, 491, 1119, 565,"▶企画名◀\nElxhibit\n▶団体名◀\nエレクトロニクス部\n▶企画説明◀\n部員たちによる個性を自重しない作品が盛り沢山！\n個性の濁流に、備えよう"],
  '309':[1450, 89, 1507, 172],
  '310':[1342, 89, 1454, 172],
  '311':[1233, 89, 1345, 172, "情報Ⅰの授業で使用します。\n座学やパソコンを使ってExcelの実習などをすることができます。\n"],
  '312':[974, 89, 1073, 172, "東棟3階職員室です。\n2年次の担任、副担任の先生がいます。"],
